...
protected:
	...
	afx_msg LRESULT OnShowDigit(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnDegOK(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnLevelOK(WPARAM wParam, LPARAM lParam);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnClickedBtnPtzDown();
	afx_msg void OnStnClickedStaticPlay();
	afx_msg void OnBnClickedButtonCapturedata();
	afx_msg void OnBnClickedButton1();
	afx_msg void OnBnClickedBtnPtzLeft();
